...
@section('contenu')
    <div class="page-header">
        <h1 class="page-title">Modifier l'<span>auteur</span></h1>
    </div>
    <div class="form-card">
        @if($errors->any())
        ...
        <form action="{{ route('auteurs.update', $auteur->id) }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="nom" class="form-control" value="{{ old('nom', $auteur->nom) }}" required>
            </div>
            <div class="mb-4">
                <label class="form-label">Prénom</label>
                <input type="text" name="prenom" class="form-control" value="{{ old('prenom', $auteur->prenom) }}" required>
            </div>
            <div class="mb-4">
                <label class="form-label">Pays</label>
                <input type="text" name="pays" class="form-control" value="{{ old('pays', $auteur->pays) }}" required>
            </div>
